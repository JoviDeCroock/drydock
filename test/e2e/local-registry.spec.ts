...
test("registry journal limits credential forwarding", async () => {
  ...
  // Every request that carries the organization's npm credential must be about
  // a package the organization owns: whoami, the staging API, or an
  // @drydock-scoped document/tarball.
