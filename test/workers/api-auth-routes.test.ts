...
const protectedRoutes: RouteCase[] = [
  ...
  { method: "POST", path: "/api/v1/publication-watches", body: { packageName: "preact" } },
  { method: "GET", path: "/api/v1/publication-watches/watch_test" },
  { method: "DELETE", path: "/api/v1/publication-watches/watch_test" },
