...
describe("ecosystem capability registry", () => {
  ...
  test("bounds atpm computed pairs to its mutable resolution lifetime", () => {
    ...
    expect(adapter?.rulesVersionSegment).toContain("atpm-12+identity-3");
    ...
    expect(ATPM_RECORD_CACHE_SCOPE).toBe("atpm-public-record-12-provenance-5-absolute-expiry-v1");
