...
/**
 * The onboarding funnel for an organization that has not finished a first
 * review.
 *
 ...
 *
 * Each step ticks on its own, and the panel stays up until the last one does.
 * The earlier version disappeared at the first scan, which meant steps 2 and 3
 * could never be seen ticking at all — the panel claimed to track a funnel it
 * structurally could not follow. Anyone who would rather not be tracked through
 * it can dismiss it.
 *
