...
export function GateDecisionDialog({
  ...
  // The authority delta only gates *approval*. Blocking a release must stay one
  // click — a maintainer who is unsure should never have to tick a box to say
  // no. The checkbox is shown whenever the authority changed, and is required
  // only when the org opted into holding the release on it.
