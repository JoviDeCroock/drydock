...
export const homePageSeo: PageSeoMetadata = {
  ...
  description:
    "Drydock pauses npm staged publishes and GitHub-gated PyPI or npm releases, reviews the exact package artifact, and pins supply-chain findings to changed lines.",
  path: "/",
};
