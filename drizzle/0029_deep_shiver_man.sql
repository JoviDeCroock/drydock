...
ALTER TABLE `scans` ADD `maintenance_kind` text;--> statement-breakpoint
ALTER TABLE `scans` ADD `maintenance_token` text;--> statement-breakpoint
ALTER TABLE `scans` ADD `maintenance_claimed_at` integer;--> statement-breakpoint
