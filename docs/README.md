...
- [`out-of-band-publishes.md`](./out-of-band-publishes.md) — the alarm for public versions of previously reviewed packages that appear with no Drydock review: watch baseline, candidate/status semantics, send-once notifications, and the operator killswitch.
