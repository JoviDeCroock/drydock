...
- Revocation is the owner's action and nothing else's: the opt-in
  ...
  background job aged the scan out. Cross-store maintenance also takes a D1
  lease before touching R2 and share creation refuses that state, closing the gap
