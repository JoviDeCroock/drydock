...
Automatic enrollment also requires a package claim belonging to this organization. Historical packages awaiting audit do not auto-enroll. Only stages from public npm qualify in production; private or unknown visibility,
