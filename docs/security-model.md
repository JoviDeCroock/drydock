...
Nothing on the atpm path holds a credential, and nothing about a publisher is persisted: staged reviews are reached by link, not by watching a repository. See [`atpm-trusted-publishing.md`](./atpm-trusted-publishing.md).
