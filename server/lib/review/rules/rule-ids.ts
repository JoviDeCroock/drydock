...
export const DETERMINISTIC_RULES = {
  ...
  publisherDirectPublishAllowed: { id: "publisher.direct-publish-allowed", risk: "anchor" },
  publisherNoEnvironment: { id: "publisher.no-environment", risk: "anchor" },
  publisherActorNotTrusted: { id: "publisher.actor-not-trusted", risk: "anchor" },
  publisherConfigOutsideProvenance: {
    id: "publisher.config-outside-provenance",
    risk: "anchor",
  },
  publisherProvenancePathChanged: { id: "publisher.provenance-path-changed", risk: "anchor" },
