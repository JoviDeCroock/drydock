...
function reviewTaskFor(ecosystem: string): string {
  switch (ecosystem) {
    ...
    case "browser":
      return "Review this browser extension release candidate. Decide whether the ZIP/XPI changes look ordinary or something is off and needs review before the GitHub workflow gate allows publishing to the extension store.";
    default:
