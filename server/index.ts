...
app.get("/api", (c) =>
  c.json({
    ...
    endpoints: {
      ...
      publicationWatches:
        "GET/POST /api/v1/publication-watches; GET/DELETE /api/v1/publication-watches/:id; GET /api/v1/publication-watches/packages/:name; GET /api/v1/publication-watches/alerts; POST /api/v1/publication-watches/:id/check; POST /api/v1/publication-watches/:id/observations/:observationId/acknowledge; POST /api/v1/publication-watches/:id/observations/:observationId/review (organization-scoped public npm publication monitoring)",
